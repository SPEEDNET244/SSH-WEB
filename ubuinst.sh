...
exit;
  ...
  echo -e 'by: @SPEEDNET' >/usr/lib/telegram
  msg -bar
...
wget https://raw.githubusercontent.com/SPEEDNET244/SSH-WEB/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/SPEEDNET244/SSH-WEB/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/SPEEDNET244/SSH-WEB/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/SPEEDNET244/SSH-WEB/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/SPEEDNET244/SSH-WEB/main/gestorssh.zip > /dev/null 2>&1
...
echo -e "                              \033[1;31mBy SPEEDNET\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/SPEEDNET244/SSH-WEB/main/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@SPEEDNET\033[0m" | lolcat
echo ""
